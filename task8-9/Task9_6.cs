            ...
            switch (syote)
            {
                ...
                case "4":
                    ...
                    if (File.Exists("tietokanta.xml"))
                    {
                        ...
                        // 2. Open file stream and assign the extracted collection back to 'leffat'
                    ...
                    {
                        // 3. Fallback message if the database file isn't present
...
public class Leffa
{
    ...
    // Explicit parameterless constructor required for successful XML deserialization
    public Leffa() { }
